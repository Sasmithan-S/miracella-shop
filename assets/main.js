...
const products = [
  {
    ...
    badge: 'Best-seller',
    description: 'La bague initiale signature Miracella. Un anneau ouvert en acier doré, orné d\'un zircon serti griffes d\'un côté et de ton initiale gravée en script de l\'autre. Ajustable, elle s\'adapte à toutes les tailles. Un cadeau personnalisé qui ne se démode jamais.',
    sizes: null,
    details: ['Acier inoxydable doré', 'Zircon blanc serti griffes', 'Bague ouverte ajustable', 'Livré dans l\'écrin Miracella'],
    featured: true,
    new: false
  },
  {
    ...
    badge: null,
    description: 'La même finesse de la bague initiale Miracella, déclinée en lettre "E" en script doré. L\'anneau ouvert doré porte d\'un côté l\'initiale calligraphiée et de l\'autre un zircon scintillant. Un bijou fin, moderne et porteur de sens.',
    sizes: null,
    details: ['Acier inoxydable doré', 'Zircon blanc serti griffes', 'Initiale "E" en script', 'Bague ouverte ajustable'],
    featured: true,
    new: false
  },
  {
    ...
    details: ['Acier argenté', 'Zircon cubique 5mm taille brillant', 'Serti 6 griffes', 'Taille au choix'],
    featured: true,
    new: true
  },
  {
    ...
    sizes: null,
    details: ['Acier doré', 'Perle dorée mate', 'Zircon brillant', 'Bague ouverte ajustable'],
    featured: false,
    new: true
  },
  {
    ...
    sizes: null,
    details: ['Acier argenté', 'Zircon blanc serti griffes', 'Initiale en script', 'Bague ouverte ajustable'],
    featured: false,
    new: false
  },
  {
    ...
    sizes: null,
    details: ['Acier doré', 'Ailes pavées de zircons', 'Motif papillon sculptural', 'Bague ouverte ajustable'],
    featured: true,
    new: false
  },
  {
    ...
    sizes: null,
    details: ['Acier doré', 'Un cœur lisse + un cœur pavé de zircons', 'Bague ouverte ajustable', 'Livré dans l\'écrin Miracella'],
    featured: true,
    new: true
  },
  {
    ...
    sizes: null,
    details: ['Acier doré', 'Motif feuille sculpté', 'Pavé de zircons sur l\'anneau', 'Bague ouverte ajustable'],
    featured: false,
    new: true
  },
  {
    ...
    sizes: null,
    details: ['Acier doré', 'Zircon blanc serti griffes', 'Initiale "T" en script', 'Bague ouverte ajustable'],
    featured: false,
    new: false
  }
];
